$(document).ready(function(){
	...
	//capturamos la industria o marca elegida 

	$(".filtro1 ul li").on("click", obtenerIndustria)
	$(".filtro2 ul li").on("click", obtenerMarca)

	function obtenerIndustria(){
		var industriaSelect = $(this).text()
		$("#industriaElegida").html(industriaSelect + " <img src='img/FlechaAbajo-01.png'>")
	}
	function obtenerMarca(){
		var marcaSelect = $(this).text()
		$("#marcaElegida").html(marcaSelect + " <img src='img/FlechaAbajo-01.png'>")
	}
	...
	//esta es la funcion que renderea la plantilla conectando con el array que contiene la base

	function renderear(){
		var itemsTemplate = _.template($("#items-template").html());
		var activarRender = itemsTemplate({conexionTemplate : base});
